	...
	<div align=center class="font1">
		...
		<form method="post" action="make_coffee.jsp">
			<table>
				...
				%>
				<tr>
					<td><input type="radio" name="recipe" value=<%=i%>></td>
					<td><span class="font1"><%=recipes[i].getName() + " " + recipes[i].getPrice()%></span></td>
				</tr>
				<%
					}
					}
				...
				<tr>
					...
					<td><span class="font1">Enter Money (integer)</span></td>
				</tr>
			</table>
			<input type="submit" value="Make Coffee">
		</form>
		<br> <br> <a href="index.jsp"><span class="font1">Back
				to CoffeeMaker Menu</span></a>
	</div>
</body>
</html>